...
$subject = 'New Inventory Enquiry';

// form field names and their translations.
// array variable name => Text to appear in the email
$fields = array('make' => 'make', 'model' => 'model', 'year' => 'year', 'info' => 'info', 'name' => 'name', 'email' => 'email', 'phone' => 'phone'); 

// message that will be displayed when everything is OK :)
$okMessage = 'Inventory form successfully submitted. Thank you, we will get back to you soon!';
...
try
{
    ...
    $emailText = "You have a new message from your inventory form\n=============================\n";
    ...
    header('Location: ../success_inventory.html');
